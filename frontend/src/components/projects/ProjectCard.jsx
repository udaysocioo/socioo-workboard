...
const ProjectCard = React.memo(({ project, onEdit, onDelete }) => {
  ...
  return (
    <motion.div
      whileHover={{ y: -5 }}
      className="bg-[#111] rounded-xl p-5 border border-zinc-800 hover:border-zinc-700 transition-colors relative group"
    >
      <div className="flex justify-between items-start mb-4">
        ...
        <div className="relative" ref={menuRef}>
          <button onClick={() => setMenuOpen(!menuOpen)} className="text-zinc-500 hover:text-zinc-300 p-1 rounded hover:bg-zinc-800 transition-colors">
